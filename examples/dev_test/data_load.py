...
with open(os.path.join('./predfin/yield_in_season/tests/dataset', 'X_S2.npy'), 'wb') as f:
    np.save(f, npy_eopatch)


##Load data and resample time series using doubly logistic intepolation
npy_eopatch_doubly = pipeline_eopatch_tfds.get_eopatch_tfds(algorithm='cubic',
...
npy_eopatch_asym = pipeline_eopatch_tfds.get_eopatch_tfds(algorithm='cubic',
                                                          asym_gaussian=True,
                                                          meta_file=meta_file,
                                                          path_column='path',
                                                          planting_date_column='days_planting',
